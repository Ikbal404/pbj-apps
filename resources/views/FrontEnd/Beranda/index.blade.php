...
@section('isi')
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Selamat Datang di Website Resmi PBJ Kabupaten Lombok Utara
              </h1>
              <p
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="template/assets/images/hero/hero-image.png"
                  alt="hero"
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[485px] text-center">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Berita terkait PBJ dan hal yang berkaitan dengan PBJ
              </p>
            </div>
          </div>
        </div>
              ...
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                <div class="mb-[50px]">
                  <h5 class="mb-5 text-lg font-medium text-dark dark:text-white">
                    Informasi pengumuman terkait Pengadaan Barang dan Jasa Kabupaten Lombok Utara.
                  </h5>
          ...
          <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div class="ud-contact-content-wrapper">
              <div class="ud-contact-title mb-12 lg:mb-[150px]">
                ...
                >
                Mari kita bicara tentang masalah Anda..
                </h2>
              </div>
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                      Jalan Tioq Tata Tunaq, Tanjung, Kab. Lombok Utara
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-[330px] max-w-full">
    ...
    <section class="pb-20 dark:bg-dark">
      <div class="container px-4">
        ...
        >
          <a href="https://lpse.lombokutarakab.go.id/eproc4/">
            <img
              src="template/assets/images/brands/lpse.svg"
              alt="graygrids"
              class="dark:hidden w-6"
            />
            <img
              src="template/assets/images/brands/lpse.svg"
              alt="graygrids"
          ...
          <a href="https://sirup.lkpp.go.id/sirup/loginctr/index">
            <img
              src="template/assets/images/brands/sirup.svg"
              alt="lineicons"
              class="dark:hidden"
            />
            <img
          ...
          <a href="https://sikap.lkpp.go.id/">
            <img
              src="template/assets/images/brands/sikap.svg"
              alt="uideck"
              class="dark:hidden"
            />
            <img
          ...
          <a href="https://ayroui.com/">
            <img
              src="template/assets/images/brands/inaproc.svg"
              alt="ayroui"
              class="dark:hidden"
            />
            <img

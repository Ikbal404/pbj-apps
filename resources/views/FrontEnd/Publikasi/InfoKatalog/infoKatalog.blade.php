...
@section('judul','PBJ | Info Katalog')
@section('isi')
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
            <div class="mb-8 overflow-hidden rounded-[5px]">
              <a href="{{url('/info-katalog-detail')}}" class="block">
                <img src="template/assets/images/blog/blog-01.jpg" alt="image"
            ...
            <div>
              ...
              <h3>
                <a href="{{url('/info-katalog-detail')}}"
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-10 wow fadeInUp group" data-wow-delay=".15s">
            <div class="mb-8 overflow-hidden rounded-[5px]">
              <a href="{{url('/info-katalog-detail')}}" class="block">
                <img src="template/assets/images/blog/blog-02.jpg" alt="image"
                  class="w-full transition group-hover:rotate-6 group-hover:scale-125" />
              </a>
            </div>
            <div>
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="mb-10 wow fadeInUp group" data-wow-delay=".2s">
            <div class="mb-8 overflow-hidden rounded-[5px]">
              <a href="{{url('/info-katalog-detail')}}" class="block">
                <img src="template/assets/images/blog/blog-03.jpg" alt="image"
                  class="w-full transition group-hover:rotate-6 group-hover:scale-125" />
              </a>
            </div>
            <div>

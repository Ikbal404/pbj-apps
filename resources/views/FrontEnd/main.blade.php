...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="template/assets/images/logo-fiv.png"
      type="image/x-icon"
    />
    <link rel="stylesheet" href="template/assets/css/swiper-bundle.min.css" />
    <link rel="stylesheet" href="template/assets/css/animate.css" />
    <link rel="stylesheet" href="template/assets/css/tailwind.css" />
  ...
  <body>
              ...
              >
                <ul class="blcok lg:flex 2xl:ml-20">
                  <li class="group relative">
                    <a
                      href="{{url('/')}}"
                      class="mx-8 flex py-2 text-base font-medium text-dark dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
                    >
                      Beranda
                    </a>
                  </li>
                  ...
                  <li class="submenu-item group relative">
                    <a
                      ...
                      class="relative mx-8 flex items-center justify-between py-2 text-base font-medium text-dark dark:text-white lg:ml-8 lg:mr-0 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10"
                    >
                      Profil
    ...
    >
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-12/12 xl:w-12/12">
            <div class="mb-10 w-full">
              ...
              <p class="mb-8 max-w-[270px] text-base text-gray-7">
                Kami menciptakan pengalaman digital untuk merek dan perusahaan dengan menggunakan
                teknologi.
              </p>
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="template/assets/images/footer/shape-1.svg" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="template/assets/images/footer/shape-3.svg" alt="" />
        </span>
    ...
    >
      <span class="block w-full max-w-[88px]">
        <img
          src="template/assets/images/brands/wa.svg"
          alt="tailgrids"
          class="dark:hidden"
        />
        <img
